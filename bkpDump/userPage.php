...
<head>
    ...
    <link
        href="https://fonts.googleapis.com/css2?family=Bebas+Neue&family=Poppins:wght@100;200;300;400;500;600;700;800;900&display=swap"
        rel="stylesheet">
...
if (class_exists('user')) {
    ...
    header('Location: https://localhost/dlog2/');
}
    ...
    <aside class="Closed">
        <div class="mainAsideContainerClosed">
            ...
            <div class="menusContainerClosed">
                ...
                <?php frontend::MenuBtn(2, 'Financeiro', 'fa-dollar-sign', 'financeiro'); ?>
        ...
        <div class="footer">
            <div class="footerPic">
                ...
                <div class="dropdown">
                    <button class="btn dropdownGear dropdown-toggle" type="button" id="dropdownMenuButton"
                        data-toggle="dropdown" aria-expanded="false">
                        <i class="fa-solid fa-user" style="font-size: 40px;"></i>
                    </button>
                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuButton">
                        <a class="dropdown-item" href="<?php echo INCLUDE_PATH_PAINEL ?>?logout"> <i
