<div class="mainContent">
    ...
    <div class="contentBox tableContainerBox" style="background-color: #fff; margin-top: 40px;">
        <?php

        //if (isset($_POST['submit'])) {
        $limitQuery = '';
        $orderQuery = "ORDER by `nfe_id` DESC";
        ...
        <table class="table table-striped table-hover table-bordered">
            ...
            <script>
                $(document).ready(function() {
                    // Adicione um evento de mudança a todos os elementos <select>
                    ...
                    function searchNfe() {
                        // Crie um objeto com os dados dos filtros selecionados
                        var form_data = $('#formRelatorio').serialize();
            ...
            $results = nfe::getListJoined($limitQuery, '', '');
                    ...
                    <td>
                        ...
                        <div id="<?php echo $key; ?>" style="min-height: 100px; margin-left: 20px; border-radius: 0 50px 20px 20px; background-color: #ececec; width: calc(inherit - 100px) !important; position: absolute; left: 0; border:#DEE2E6 1px solid; display: none; align-self: center; padding: 30px 0; margin-top: 13px;">
                            ...
                            <div class="mainTableMenuContainer" id="mainTableMenuContainer">
                                <div class="tableContainerHeader">
                                    <h1><i class="fa-solid fa-truck-fast"></i>Pedido #
                                        <?php echo $currentNfe->getId(); ?>
                                    </h1>
                                </div>
                                <div class="formsContainer">
                                    ...
                                    <form class="formContainer">
                                        ...
                                        <?php frontend::readingForm($key, 'Número', 'w50', 'numero', $currentNfe->getDestNumero()); ?>
                                        <?php frontend::readingForm($key, 'P. de referência', 'w50', 'referência', $currentNfe->getDestPReferencia()); ?>
